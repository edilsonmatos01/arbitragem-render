...
var DatabaseClient = /** @class */ (function () {
    ...
    DatabaseClient.prototype.findSpread = function (symbol) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.pool.query(query, [symbol])];
                    case 1:
                        result = _a.sent();
    ...
    DatabaseClient.prototype.createSpread = function (data) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    DatabaseClient.prototype.deleteOldSpreads = function (daysToKeep) {
        return __awaiter(this, void 0, void 0, function () {
            var query;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.pool.query(query, [daysToKeep])];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
