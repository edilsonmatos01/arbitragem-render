...
function startWebSocketServer(httpServer) {
    ...
    wss.on('connection', function (ws, req) {
        ...
        clients.push(ws);
        console.log("[Conex\u00E3o] Novo cliente conectado. Total: ".concat(clients.length));
        ws.on('pong', function () {
            heartbeat(ws);
        });
        ...
        ws.on('close', function (code, reason) {
            console.log("[Conex\u00E3o] Cliente desconectado. C\u00F3digo: ".concat(code, ", Raz\u00E3o: ").concat(reason));
            clients = clients.filter(function (client) { return client !== ws; });
            console.log("[Conex\u00E3o] Total de clientes restantes: ".concat(clients.length));
        });
    });
